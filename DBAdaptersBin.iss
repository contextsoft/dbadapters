...
AppVerName=Additional Database Extensions Adapters v.3.31
AppCopyright=Copyright © 2003-2013, Context Software LLC.
...
Source: AnyDAC2\adapter\*.dll; DestDir: {app}; Components: AnyDAC2
