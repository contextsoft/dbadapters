...
uses
  ...
  ActnList, DBISAMTb, ToolWin, ComCtrls, Menus, dbSchema, AppEvnts,
  DB, DBISAMEv, DBISAMExt, ImgList, DBISAMOpenDatabase, ExtCtrls, StdCtrls,
  DBISAMCt, dbDocument, dbManager;
...
type
  TfrmEZBooksMain = class(TForm)
    ...
    Help1: TMenuItem;
    About1: TMenuItem;
    OpenDBDialog: TDBISAMOpenDatabaseDialog;
    ...
    dbDest: TDBISAMDatabaseExt;
    sDest: TDBISAMSession;
    N5: TMenuItem;
    ...
    procedure dbMainProgress(Sender: TDBISAMDatabaseExt;
      const Operation: String; PercentDone: Byte; var Abort: Boolean);
  private
    { Private declarations }
    procedure DoOnHint(Sender: TObject);
    procedure OpenUpdateDatabase(Database: TDBISAMDatabaseExt);
  public
    { Public declarations }
...
{$ENDIF}
  ...
  fBrowseObjects, dReferences, dbExtUtils;
...
begin
  ...
  dbMain.Directory := GetRelativePath('Data');
...
begin
  ...
  begin
    ...
    try
      ...
      if dbMain.Session.SessionType = stLocal then
        ForceDirectories(dbMain.Directory);
      dbMain.Open;
...
procedure TfrmEZBooksMain.dbMainProgress(Sender: TDBISAMDatabaseExt;
  const Operation: String; PercentDone: Byte; var Abort: Boolean);
begin
...
procedure TfrmEZBooksMain.OpenUpdateDatabase(Database: TDBISAMDatabaseExt);
begin
  Database.Open;
