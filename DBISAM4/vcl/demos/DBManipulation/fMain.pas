...
uses
  ...
  StdCtrls, Db, DBISAMTb, DBISAMExt, ExtCtrls,
  DBISAMOpenDatabase, Grids, DBGrids, Menus, ComCtrls, ActnList, ToolWin,
  ImgList, dbSchema, DBCtrls, DBActns, dbManager;
...
type
  TfrmMainForm = class(TForm)
    ...
    OpenDatabaseDialog: TDBISAMOpenDatabaseDialog;
...
begin
  ...
  Database.Directory := ExtractFilePath(Application.ExeName) + 'Data';
...
begin
  ...
  begin
    ...
    Database.CreateNewDatabase(True, True, False);
