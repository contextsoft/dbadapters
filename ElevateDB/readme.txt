==================================================
Context Database Extensions - Elevate DB Adapter
...
that none of the TEDBxxxExt components are installed.

Please also delete EDBExtPkgDX.* files from default Delphi\BDS 
BPL directory (e.g. $(DELPHI)\Projects\Bpl).

In order to install EDB extensions components into Delphi IDE
you should:

- Make sure, that you have standard EDB components installed in 
...
EDBExtPkgDx.dpk. (where 'x' is your version of Delphi). Packages 
