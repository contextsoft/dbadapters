==================================================
Context Database Extensions - FIBPlus Adapter
...
that none of the TFIBxxxExt components are installed.

Please also delete FIBExtPkgDX.* files from default Delphi\BDS 
BPL directory (e.g. $(DELPHI)\Projects\Bpl).

In order to install FIBPlus extensions components into Delphi IDE
you should:

- Make sure, that you have standard FIBPlus components installed in 
...
FIBExtPkgDx.dpk. (where 'x' is your version of Delphi). Packages 
