...
uses
  ...
  fEdit, Db, StdCtrls, Buttons, ExtCtrls, DBCtrls, Grids, DBGrids, ComCtrls,
  Mask, dbSchema, nxdb, nxdbext, dbMemDS, dbDocument;
...
type
  TfrmEditOrders = class(TfrmEditObject)
    ...
    DBMemo1: TDBMemo;
    Label11: TLabel;
    tblOrderLines: TDbMemDataset;
    tblPaymentLines: TnxTableExt;
...
uses dReferences, fBrowseCustomers, fEditPayments, dbExtUtils, fMain;
