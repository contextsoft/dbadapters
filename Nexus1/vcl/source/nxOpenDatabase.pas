...
uses Windows, SysUtils, Classes, Graphics, Forms, Controls, StdCtrls,
  Buttons, ExtCtrls, Db, dbSchema, dbExtUtils, nxdb, nxtcCOMTransport, nxtnNamedPipeTransport,
...
uses nxDBExt, ShlObj, nxsrSqlEngineBase, nxsqlEngine, nx1xAutoComponent,
  nxsrServerEngine;
