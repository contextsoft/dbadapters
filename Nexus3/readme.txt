==================================================
Context Database Extensions - Nexus 3 Adapter
...
In order to install Nexus 3 extensions components into Delphi IDE
you should:

- Make sure, that you have standard Nexus 3 components installed in 
